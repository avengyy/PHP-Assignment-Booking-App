                    ...
                    if (isset($_POST['search'])) {
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_array($result)) {
                          ...
                          echo "<a href='$category-detail.php?id=$id' class='btn-inline btn-inline--card'>";
                        ...
                        echo "<div class='package-card'>No Results returned</div>";
                      }
                    }
                  }
                } else {
                  echo "<div class='package-card'>No Search Query Entered</div>";
                }
              ?>
