...
<html lang="en">
  ...
  <head>
    ...
    <title>RedCloud &mdash; Tours</title>
  </head>
        ...
        <main class="detail-view">
          <div class="gallery">
            <figure class="gallery__item">
              <img src="img/tour-1.jpg" alt="Photo of hotel 1" class="gallery__photo">
            </figure>
            <figure class="gallery__item">
              <img src="img/tour-2.jpg" alt="Photo of hotel 2" class="gallery__photo">
            </figure>
            <figure class="gallery__item">
              <img src="img/tour-3.jpg" alt="Photo of hotel 3" class="gallery__photo">
            </figure>
          </div>

          <div class="overview">
            <h1 class="overview__heading">
              Tours &mdash; Best offers tailored for your vacation
            </h1>
              ...
              <?php
                ...
                if (mysqli_num_rows($result) > 0) {
                  while($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<div class='package-card__paragraph'>$subtitle</div>";
                    echo "<a href='tour-detail.php?id=$id' class='btn-inline btn-inline--card'>";
