...
if (isset($_GET['id'])) {
  ...
  if (!empty($_POST)) {
    if (empty($_POST['user']) || empty($_POST['password'])) {
      ...
      window.location.href = 'tour-detail.php?id=$id';
      </script>";
    } else {
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="tour-detail.php?id=<?php echo "$id" ?>" method="POST">
        ...
        <main class="detail-view">
          <div class="gallery">
            <figure class="gallery__item">
              <img src="img/tour-1.jpg" alt="Photo of tour 1" class="gallery__photo">
            </figure>
            <figure class="gallery__item">
              <img src="img/tour-2.jpg" alt="Photo of tour 2" class="gallery__photo">
            </figure>
            <figure class="gallery__item">
              <img src="img/tour-3.jpg" alt="Photo of tour 3" class="gallery__photo">
            </figure>
          </div>
            ...
            <div class="description">
              ...
              <div class="recommend">
                <p class="recommend__count">
                  Lucy and 3 other friends recommend this tour.
                </p>
